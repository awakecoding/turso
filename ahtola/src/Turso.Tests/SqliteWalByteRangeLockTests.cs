...
public sealed class SqliteWalByteRangeLockTests
{
    ...
    public void LockPrimitiveFailsClosedOnUnsupportedPlatforms()
    {
        ...
        var path = Path.Combine(Path.GetTempPath(), $"turso-wal-lock-unsupported-{Guid.NewGuid():N}");
        try
        {
    ...
    private sealed class CrossProcessLockWorker : IDisposable
    {
            ...
            TimeSpan timeout)
        {
            ...
            startInfo.ArgumentList.Add(
                "--TestCaseFilter:FullyQualifiedName=Turso.Tests.SqliteWalByteRangeLockTests."
