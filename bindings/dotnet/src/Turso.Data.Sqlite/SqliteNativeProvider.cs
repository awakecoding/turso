...
public abstract class SqliteNativeProviderFactory
{
    ...
    public abstract void UnregisterFunctions(TursoNativeDatabase database, string name);
    ...
    public abstract void UnregisterCollation(TursoNativeDatabase database, string name);

    /// <summary>Enables or disables extension loading.</summary>
    public abstract void EnableExtensions(TursoNativeDatabase database, bool enable);

    /// <summary>Loads a SQLite extension.</summary>
    public abstract void LoadExtension(TursoNativeDatabase database, string file);
}
