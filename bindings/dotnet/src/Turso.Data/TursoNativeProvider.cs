...
/// </summary>
public static class TursoNativeProvider
{
    ...
    private static TursoNativeProviderFactory? s_factory;

    /// <summary>
    /// Registers the native local-provider factory supplied by the companion package.
    /// </summary>
    public static void Register(TursoNativeProviderFactory factory)
    {
    ...
    internal static TursoNativeDatabase OpenDatabase(
        string path,
        ...
        string? encryptionKey)
    {
        ...
        if (factory is null)
        {
            try
            {
                var loadContext = AssemblyLoadContext.GetLoadContext(typeof(TursoNativeProvider).Assembly);
        ...
        return factory?.OpenDatabase(path, cipher, encryptionKey)
            ?? throw new NotSupportedException(
                ...
                "Add a matching PackageReference to use the native Turso SDK.");
    }
}
...
/// </summary>
public abstract class TursoNativeProviderFactory
{
    /// <summary>
    /// Opens a database through the native Turso SDK.
    /// </summary>
    public abstract TursoNativeDatabase OpenDatabase(
        string path,
        TursoEncryptionCipher? cipher,
        string? encryptionKey);
}
...
/// </summary>
public abstract class TursoNativeDatabase : IDisposable
{
    /// <summary>
...
/// </summary>
public abstract class TursoNativeStatement : IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public abstract void BindParameter(int index, TursoValue value);

    /// <summary>
    /// Binds a value by parameter name.
    /// </summary>
    public abstract int BindNamedParameter(string name, TursoValue value);
    ...
    /// </summary>
    public abstract TursoValue GetValue(int ordinal);
