...
/// <summary>
/// Provides data for the <see cref="TursoDataAdapter.RowUpdating"/> event.
/// </summary>
public sealed class TursoRowUpdatingEventArgs(
    DataRow dataRow,
    IDbCommand? command,
...
/// <summary>
/// Provides data for the <see cref="TursoDataAdapter.RowUpdated"/> event.
/// </summary>
public sealed class TursoRowUpdatedEventArgs(
    DataRow dataRow,
    IDbCommand? command,
    StatementType statementType,
    DataTableMapping tableMapping)
