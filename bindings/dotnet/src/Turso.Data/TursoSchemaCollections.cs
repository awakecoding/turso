...
/// <summary>
/// Builds the ADO.NET schema surfaces shared by <see cref="TursoConnection"/> and the
/// <c>Turso.Data.Sqlite</c> facade.
/// </summary>
/// <remarks>
...
/// </remarks>
internal static class TursoSchemaCollections
{
    ...
    private static readonly string[] ReservedWordList =
        ["ABORT", "ALTER", "CREATE", "DELETE", "DROP", "INSERT", "SELECT", "UPDATE"];
