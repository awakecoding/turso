...
public sealed class FacadeEncryptionFileSystemSnapshotOwnershipRegressionTests
{
    ...
    private static DbConnection CreateConnection(string facade, string connectionString)
        => facade switch
        {
            ...
            "turso" => new global::Turso.TursoConnection(connectionString),
    ...
    private static TursoEncryptionFileSystem GetOwnedEncryptionFileSystem(DbConnection connection)
    ...
    private static TursoEncryptionFileSystem? GetOwnedEncryptionFileSystemOrNull(DbConnection connection)
    {
