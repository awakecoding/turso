...
{
    [Test]
    public void TursoManagedReaderUsesCoreResultRowsAndMetadata()
    {
        ...
        connection.Open();
        using var command = new TursoCommand { Connection = connection };
        using var reader = new TursoDataReader(command, null, statement, CommandBehavior.Default);
