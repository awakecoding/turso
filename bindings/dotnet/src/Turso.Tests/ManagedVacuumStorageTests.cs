...
public sealed class ManagedVacuumStorageTests
{
    ...
    public void VacuumAttachedSchemaAndIntoPreserveAttachmentEncryptionKey()
    {
        ...
        using var mainEncryption = TursoEncryptionOptions.FromHex(
            TursoEncryptionCipher.Aes256Gcm,
            MainEncryptionKey);
        using var mainFileSystem = new TursoEncryptionFileSystem(inner, mainEncryption);
        ...
        using var attachedEncryption = TursoEncryptionOptions.FromHex(
            TursoEncryptionCipher.Aes256Gcm,
            AttachedEncryptionKey);
        using var attachedFileSystem = new TursoEncryptionFileSystem(inner, attachedEncryption);
