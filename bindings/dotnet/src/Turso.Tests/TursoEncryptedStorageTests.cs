...
public class TursoEncryptedStorageTests
{
    ...
    public void PageStoreEncryptsPagesAndReopensOnlyWithTheCorrectKey()
    {
        ...
        using (var raw = fileSystem.OpenFile("encrypted.db", FileOpenMode.OpenExisting, readOnly: true))
        {
            ...
            encryptedFirstPage.AsSpan(0, 7).ToArray().Should().Equal("Turso"u8.ToArray().Append((byte)0).Append((byte)2));
    ...
    private static byte[] CreatePlainPage(int pageSize, byte fill)
    {
        ...
        page.AsSpan(0, pageSize - TursoPageEncryptionMetadataSize).Fill(fill);
        return page;
    }
    ...
    private static byte[] CreateFirstPage(int pageSize)
    {
        ...
        {
            ReservedSpace = TursoPageEncryptionMetadataSize,
            ChangeCounter = 1,
        ...
        ReadOnlySpan<byte> nonce)
    {
        ...
        const int metadataSize = TursoPageEncryptionMetadataSize;
    ...
    private const int TursoPageEncryptionMetadataSize = 28;
}
